...
| 65-80 bits | ✅ Most real-world attackers | Industry standard |
...
👉 **[password_generator_challenge.py](https://github.com/fosres/AppSec-Exercises)** - LeetCode-style Python file with boilerplate code  
👉 **[password_generator_exercise.md](https://github.com/fosres/AppSec-Exercises)** - Complete exercise specification with entropy tables

Or clone the entire repository:
```bash
git clone https://github.com/fosres/AppSec-Exercises.git
cd AppSec-Exercises/week1_password_generator/
```
...
📥 **[Get the exercise files above](#download-exercise-files)** or visit the [GitHub repository](https://github.com/fosres/AppSec-Exercises)
