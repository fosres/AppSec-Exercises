...
cd AppSec-Exercises/week-01-port-scanner

# Or download just the grader
curl -O https://raw.githubusercontent.com/fosres/AppSec-Exercises/main/week-01-port-scanner/grade_port_scanner.py
```
...
- Week 2: Concurrent port scanning with threading
- Week 3-26: Full security engineering curriculum
...
This is **Week 1** of a comprehensive security engineering curriculum. All challenges include:
...
**Coming soon:**
- Week 2: Concurrent port scanning (threading, asyncio)
- Week 3: API rate limiting implementation
- Week 4: JWT token security audit
- Week 5-26: Full AppSec curriculum
...
**Part of:** 48-Week Security Engineering Curriculum (Week 1)  
