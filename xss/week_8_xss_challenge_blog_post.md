---
title: "Security Challenge: Build an XSS Prevention Framework in Python (100 Tests)"
published: false
description: "A LeetCode-style secure coding challenge — implement a context-aware XSS prevention framework covering HTML, attribute, JavaScript, URL, and CSP output contexts. 100 comprehensive tests. P2P AppSec Exercise Series."
...
> ⭐ **If this challenge is useful to you, please [star the repo on GitHub](https://github.com/fosres/SecEng-Exercises)** — it helps surface these exercises for other Security Engineers.
>
> 📊 **Quick question:** [Why are you reading this post?](https://strawpoll.com/wby5QoKAkyA) (30-second poll — genuinely useful for knowing what to write next)
...
## The 100-Test Gauntlet

Your implementation faces 100 deterministic tests across ten categories — ten tests per category:
...
| 91–100 | Redirect Security Edge Cases | `javascript://` authority bypass, port-bearing URLs, scheme case-sensitivity |

### Sample Output

```
╔════════════════════════════════════════════════════════════════════╗
║        XSS PREVENTION FRAMEWORK — 100 COMPREHENSIVE TESTS         ║
╚════════════════════════════════════════════════════════════════════╝
...
git clone https://github.com/fosres/SecEng-Exercises
cd SecEng-Exercises/xss
python3 xss_prevention_100_tests.py
```

### What You'll Get
- A single Python file with the empty `XSSPrevention` class
- 100 deterministic test cases with colored pass/fail output
...
A candidate who passes all 100 tests has demonstrated the foundational secure coding knowledge expected of an Application Security Engineer at the junior-to-mid level.
...
| File | Description |
|---|---|
| [xss_prevention_100_tests.py](https://github.com/fosres/SecEng-Exercises/blob/main/xss/xss_prevention_100_tests.py) | **Challenge file** — empty `XSSPrevention` class + full 100-test suite. Start here. |
| [xss_prevention_100_tests_solution.py](https://github.com/fosres/SecEng-Exercises/blob/main/xss/xss_prevention_100_tests_solution.py) | **Solution file** — reference implementation. Check this after you pass, not before. |

Both files live in the [`xss/` directory](https://github.com/fosres/SecEng-Exercises/tree/main/xss) of the [SecEng-Exercises repository](https://github.com/fosres/SecEng-Exercises).

If these exercises are useful to you, a ⭐ [star on the repo](https://github.com/fosres/SecEng-Exercises) helps other Security Engineers find them. And if you have a minute, [let me know why you read this post](https://strawpoll.com/wby5QoKAkyA) — it directly shapes what I write next.
