...
def test_caesar_cipher():
	...
	assert caesar_encrypt("SECURITY", 10) == "COMBKDSDI"
	...
	assert caesar_encrypt("Hello", 3) == "Khoor"
	assert caesar_encrypt("PyThOn", 5) == "UdYmTs"
	assert caesar_encrypt("SeCuRiTy", 10) == "CoCkBsNi"
	...
	assert caesar_encrypt("user:password123", 7) == "blly:whzzdvyk123"
	...
	assert caesar_encrypt("test (with) [brackets]", 4) == "xiwx (amxl) [fvegoisxw]"
	...
	assert caesar_encrypt("PYTHON", -10) == "FIDSXD"
	assert caesar_encrypt("test", -7) == "mxlm"
	assert caesar_encrypt("CAESAR", -13) == "PNRFNE"
	assert caesar_encrypt("SECURITY", -20) == "YIGAROZE"
	...
	assert caesar_decrypt("COMBKDSDI", 10) == "SECURITY"
	...
	assert caesar_encrypt("test", 100) == "xiwx"  # 100 % 26 = 22
	assert caesar_encrypt("ABC", -27) == "ZAB"  # -27 % 26 = -1
	assert caesar_encrypt("PYTHON", 1000) == "DCNBIH"  # 1000 % 26 = 12
